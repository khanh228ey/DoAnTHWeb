            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <form method="post" action="adminController.php?controller=indexLSPGET">
                        <div class="card-footer">
                                <button type="submit" id="maloaisp" class="btn btn-primary">Back</button>
						</div>
                        </form>
                        <form method="post" action="adminController.php?controller=deleteLSPPOST">
							<div class="card-body">
								<div class="form-group" style="display: none;">
                                    <label for="exampleInputEmail1">Mã nhà sản xuất</label> <input type="text" class="form-control" id="maloaisp" name="maloaisp" value="<?php echo $re['maloaisp']; ?>" placeholder="Nhập sản phẩm" >
                                </div>
							...
							<div class="card-footer">
                                <button type="submit" id="maloaisp" class="btn btn-danger">Delete</button>
							</div>
						</form>
