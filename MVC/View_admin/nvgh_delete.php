            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form method="post" action="adminController.php?controller=deleteNvghPOST">
                            <div class="card-body">
                                <div class="form-group" style="display: none;">
                                    <label for="exampleInputEmail1">Mã nhà sản xuất</label> <input type="text" class="form-control" id="manv" name="manv" value="<?php echo $re['manv']; ?>" placeholder="Nhập sản phẩm">
                                </div>
