                                        ...
                                        <td class="product-image">
                                                <div class="product-thumbnail">
                                                    <div class="product-thumbnail-wrapper">
                                                        <img class="product-thumbnail-image" alt="' . $itemcart['ten'] . '" src="' . $itemcart['image'] . '" />
                                                    </div>
                                                    <span class="product-thumbnail-quantity" aria-hidden="true">' . $itemcart['Quantity'] . '</span>
                                                </div>
                                            </td>
                                            <td class="product-description">
                                                <span class="product-description-name order-summary-emphasis">' . $itemcart['ten'] . '</span>
            ...
            <div class="main">
							<div class="main-header">
								...
								<a href="/MVC/controller/productController.php?controller=indexProductGET" class="logo">
										...
										<h1 class="logo-text">TanThoai</h1>   
														...
														<div class="content-box-row content-box-row-padding">
															<div class="section-content">
																...
																<h3>Thông tin giao hàng</h3>
																				...
																				<br>
                                                                                <?php echo $getinforbill['phonenumber']?>
																				<br>
																		<p>
