...
<head>
    <link rel="shortcut icon" href="//theme.hstatic.net/200000588991/1000965463/14/favicon.png?v=226" type="image/png" />
    <title>
        Figure Funny Order - Thanh toán đơn hàng
    </title>

    <meta name="description" content="Figure Funny Order - Thanh to&#225;n đơn h&#224;ng" />
    ...
    <link href='//theme.hstatic.net/200000588991/1000965463/14/check_out.css?v=226' rel='stylesheet' type='text/css' media='all' />
    ...
    <div class="banner">
        <div class="wrap">
            <a href="#" class="logo">
                ...
                <h1 class="logo-text">Figure Funny Order</h1>
    ...
    <button class="order-summary-toggle order-summary-toggle-hide">
        <div class="wrap">
            <div class="order-summary-toggle-inner">
                ...
                <div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="372000000">
                    <span class="total-recap-final-price">3,720,000₫</span>
                </div>
            </div>
        </div>
    </button>
                                        ...
                                        <td class="product-image">
                                            <div class="product-thumbnail">
                                                    <div class="product-thumbnail-wrapper">
                                                        <img class="product-thumbnail-image" alt="' . $itemcart['masp'] . '" src="' . $itemcart['Image'] . '" />
                                                    </div>
                                                    <span class="product-thumbnail-quantity" aria-hidden="true">' . $itemcart['Quantity'] . '</span>
                                                </div>
                                            </td>
                                            <td class="product-description">
                                                <span class="product-description-name order-summary-emphasis">' . $itemcart['tensp'] . '</span>


                                            </td>
                                            <td class="product-quantity visually-hidden">' . $itemcart['Quantity'] . '</td>
                                            <td class="product-price">
                                                <span class="order-summary-emphasis">' . number_format($itemcart['Quantity'] * $itemcart['gia'], 0, '.', '.') . 'đ' . '</span>
                                            </td>
                                        </tr>';
                                            }
                                        }
            ...
            <div class="main">
                <div class="main-header">
                    ...
                    <a href="#" class="logo">
                        ...
                        <h1 class="logo-text">Tân Thoại</h1>
                ...
                <div class="main-content">
                    ...
                    <div class="step">
                            ...
                            <div class="section">
                                ...
                                <div class="section-content section-customer-information no-mb">
                                    ...
                                    if (isset($_SESSION['accountuser'])) {
                                        ...
                                        echo '   <div class="logged-in-customer-information">';
                                        echo '     <div class="logged-in-customer-information-avatar-wrapper">';
                                        echo '         <div class="logged-in-customer-information-avatar gravatar" style="background-image: url(//www.gravatar.com/avatar/245cf079454dc9a3374a7c076de247cc.jpg?s=100&d=blank);filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="//www.gravatar.com/avatar/245cf079454dc9a3374a7c076de247cc.jpg?s=100&d=blank", sizingMethod="scale")"></div>';
                                        echo '     </div>';
                                        echo '       <p class="logged-in-customer-information-paragraph">';
                                        echo '      ' . $user['firstname'] . " " . $user['lastname'] . ' (' . $user['email'] . ')';
                                        echo '               <br />';
                                        echo '       <a href="/MVC/controller/userController.php?controller=logout">Đăng xuất</a>';
                                        echo '    </p>';
                                        echo ' </div>';
                                        echo '<div class="fieldset">
                                        <div class="field   ">
                                            <div class="field-input-wrapper">
                                                <label class="field-label" for="Họ và tên">' . $user['firstname'] . " " . $user['lastname'] . '</label>
                                                <input placeholder="Họ và tên" autocapitalize="off" spellcheck="false" class="field-input" size="30" type="text" id="name" name="name" value="' . $user['firstname'] . " " . $user['lastname'] . '" autocomplete="false" />
                                            </div>

                                        </div>
                                        <div class="field field-required   ">
                                            <div class="field-input-wrapper">
                                                <label class="field-label" for="billing_address_phone">Email</label>
                                                <input autocomplete="false" placeholder="Email" autocapitalize="off" spellcheck="false" class="field-input" type="email" id="email" name="email" value="' . $user['email'] . '" />
                                            </div>
                                        ...
                                        <div class="field field-required   ">
                                            <div class="field-input-wrapper">
                                                ...
                                                <input autocomplete="false" placeholder="Số điện thoại" autocapitalize="off" spellcheck="false" class="field-input" size="30" maxlength="15" type="tel" id="phonenumber" name="phonenumber" value="' . $user['phonenumber'] . '" />
                                            </div>

                                        </div>
                                        <div class="field field-required   ">
                                        <div class="field-input-wrapper">
                                            <label class="field-label" for="billing_address_phone">Địa chỉ</label>
                                            <input autocomplete="false" placeholder="Địa chỉ" autocapitalize="off" spellcheck="false" class="field-input"  type="text" id="address" name="address" value="' . $user['diachi'] . '" />
                                        </div>
                                        ...
                                        echo '						Bạn đã có tài khoản?';
                                        echo '						<a href="/MVC/controller/userController.php?controller=loginUserGET">Đăng nhập</a>';
                                        echo '					</p>';
                                        echo '<div class="fieldset">
                                        ...
                                        <div class="field-input-wrapper">
                                            <label class="field-label" for="billing_address_phone">Email</label>
                                            <input autocomplete="false" placeholder="Email" autocapitalize="off" spellcheck="false" class="field-input" type="email" id="email" name="email" value="" />
                                        </div>
                        ...
                        <div class="step-footer" id="step-footer-checkout">
                            ...
                            <!-- </form> -->
                            <a class="step-footer-previous-link" href="/MVC/controller/productController.php?controller=indexCartGET">
                                Giỏ hàng
                            </a>
...
<script>
    $(document).ready(function() {
        $('#submit-btn').click(function(e) {
            ...
            var firtnamelastname = $('#name').val();
            var email = $('#email').val();
            var phonenumber = $('#phonenumber').val(); // get the input value
